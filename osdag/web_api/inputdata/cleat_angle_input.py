...
class CleatAngleInputData(InputDataBase):
    def process(self, **kwargs):
        connectivity, boltDiameter, angleList = kwargs["connectivity"], kwargs["boltDiameter"], kwargs["angleList"]
        propertyClass, email  = kwargs["propertyClass"], kwargs["email"]
        
        if (connectivity is None and boltDiameter is None and propertyClass is None and angleList is None):
